...
# Exercise 4 of 7 `r emo::ji("airplane")`
...
# Exercise 5 of 7 `r emo::ji("rocket")`
...
1. Log in at github.com and craete a new public repo (use + button in top right-hand corner)
...
# Exercise 6 of 7 `r emo::ji("rocket")`
...
1. Click on the <span style="background:#2da44e; color:white; border: 1px solid; border-radius: 6px;">Code</span> button and copy the HTTPS url to your clipboard.
...
# Exercise 7 of 7 `r emo::ji("moon")`

#### Task: Create a new branch, add a new file and submit your changes as a pull request
