...
1. Enter `git clone <your partners url>` to clone their repo: for example:
	<span class=myCode>git clone https://github.com/MarkHanly/GitPrax.git</span>
...
1. Use <span class=myCode>cd</span> to navigate inside your locally cloned copy of your partner’s repo
1. Use <span class=myCode>git status</span> to confirm you have edited the file
...
1. Use <span class=myCode>git push</span> to push your local changes to your partner’s GitHub repo
1. Use <span class=myCode>cd</span> to navigate back to your own repo
1. Use <span class=myCode>git pull</span> to sync in your partner’s changes
